...
type KindPersonTableProps = {
  columns: ColumnsType<PersonKindType>,
  filtered_data: PersonKindType[],
  loading: boolean,
  filters: FiltersType,
  handleTableChange: (
...
const PersonKindTable: React.FC<KindPersonTableProps> = ({ columns, filtered_data, loading, filters, handleTableChange, locale }) => {
...
export default memo(PersonKindTable)
