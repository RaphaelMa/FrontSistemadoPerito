...
type TableProps = {
  columns: ColumnsType<KeywordType>,
  filtered_data: KeywordType[],
  loading: boolean,
  filters: FiltersType,
  handleTableChange: (
...
const KeywordTable: React.FC<TableProps> = ({ columns, filtered_data, loading, filters, handleTableChange, locale }) => {
...
export default memo(KeywordTable)
