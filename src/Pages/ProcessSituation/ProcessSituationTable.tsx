...
type TableProps = {
  columns: ColumnsType<ProcessSituationType>,
  filtered_data: ProcessSituationType[],
  loading: boolean,
  filters: FiltersType,
  handleTableChange: (
...
const ProcessSituationTable: React.FC<TableProps> = ({ columns, filtered_data, loading, filters, handleTableChange, locale }) => {
...
export default memo(ProcessSituationTable)
