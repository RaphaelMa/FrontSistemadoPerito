...
type PeopleTableProps = {
  columns: ColumnsType<StatusImpeachment>,
  filtered_data: StatusImpeachment[],
  loading: boolean,
  filters: FiltersType,
  handleTableChange: (
...
const PeopleTable: React.FC<PeopleTableProps> = ({ columns, filtered_data, loading, filters, handleTableChange, locale }) => {
