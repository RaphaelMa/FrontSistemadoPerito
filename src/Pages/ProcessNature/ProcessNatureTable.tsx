...
type TableProps = {
  columns: ColumnsType<ProcessNatureType>,
  filtered_data: ProcessNatureType[],
  loading: boolean,
  filters: FiltersType,
  handleTableChange: (
...
const ProcessNatureTable: React.FC<TableProps> = (props) => {
...
export default memo(ProcessNatureTable)
