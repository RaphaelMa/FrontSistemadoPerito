...
type JudicialDistrictProps = {
  columns: ColumnsType<JudicialDistrictType>,
  filtered_data: JudicialDistrictType[],
  loading: boolean,
  filters: FiltersType,
  handleTableChange: (
...
const JudicialDistrict: React.FC<JudicialDistrictProps> = ({ columns, filtered_data, loading, filters, handleTableChange, locale }) => {
...
export default memo(JudicialDistrict)
